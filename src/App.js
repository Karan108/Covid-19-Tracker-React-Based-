...
function App() {
  ...
  // url -- https://diseases.sh/v3/covid-19/countries
  useEffect(() => {
    ...
    <div className="app">
      <div className="app__left"><div className="app__header">
        ...
        <div className="app__stats">
          <InfoBox isRed active={casesType === "cases"} onClick={e => setCasesType("cases")} title="Coronairus cases" cases={prettyPrintStat(countryInfo.todayCases)} total={prettyPrintStat(countryInfo.cases)}></InfoBox>
      ...
      <Card className="app__right">
        <CardContent>
          ...
          <h3 className="graph--title">Worldwide New  {casesType}</h3>
          {/* Graphs */}
